...
Enter the type of Expression : 1
Enter the Prefix Expression  : ++a*bcd

Infix Expression with recursion: a + b * c + d
Prefix Expression with recursion: + + a * b c d
Postfix Expression with recursion: a b c * + d +
Infix Expression with non-recursion: a + b * c + d
Prefix Expression with non-recursion: + + a * b c d
Postfix Expression with non-recursion: a b c * + d +
...
1. Prefix Expression 
2. Postfix Expression 
Enter the type of Expression : 2
